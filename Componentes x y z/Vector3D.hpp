...
class Vector3D{
  //! \name Atributos privados de la clase Vector3D
   private: 
	...
	double _x; //!< Componente x del Vector3D
	double _y; //!< Componente y del Vector3D
	double _z; //!< Componente z del Vector3D
	...
	//! \name Constructores de la clase Vector3D
		...
		*/
		...
		/*! 
				...
				\sa        get1()
		*/
		inline double get1() const {return _x;}
		...
		/*! 
				...
				\sa        get2()
		*/
		inline double get2() const {return _y;}
		...
		/*! 
				...
				\sa        get3()
		*/
		inline double get3() const {return _z;}
		...
		*/
		...
		//! \name Funciones que utilizan un objeto de la clase Vector3D, pero que no pertenecen a la clase Vector3D

			/*! 
					\fn        Vector3D &operator* (double const k, Vector3D const &objeto)
					...
					\sa        get1(), get2(), get3(), set1(), set2(), set3()
			*/	
			Vector3D &operator* (double const k, Vector3D const &objeto);
